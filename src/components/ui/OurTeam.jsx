        ...
        <SectionLayout className={"flex gap-8 items-center "}>
          <div className="basis-1/2 flex flex-col gap-8  ">
            ...
            <p className="font-semibold tracking-wider text-xl">
              ...
              challenges in building administration, and empowering builders
              with the technologically advanced tools and resources they need to
              compete in an evolving industry. We’re proud to have partnered
              with some of the world’s largest, most prominent residential
              building companies, helping them scale up, reduce costs, and
              deliver projects on time and on budget.
            </p>
            <p className="font-semibold tracking-wider text-xl">
              {" "}
              We’re an experienced team of former builders, industry leaders,
              and experienced professionals located around the globe: North
              America, Australia, Philippines, and Singapore. Together, we’re on
              a mission to empower visionary builders.
            </p>
          </div>
